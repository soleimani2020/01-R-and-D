...
The program demonstrates how **Batch Gradient Descent**, **Stochastic Gradient Descent (SGD)**, and **Mini-Batch Gradient Descent** optimize model parameters using the **Mean Squared Error (MSE)** loss function.

This project is designed as a learning and portfolio example to illustrate how different gradient descent strategies behave during model training.
